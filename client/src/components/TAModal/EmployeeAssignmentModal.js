                    ...
                    <div className="background">
                        ...
                        <div class="table-container">
                            <table className='table'>
                                ...
                                <thead>
                                    <tr style={{ backgroundColor: "#a8e890" }}>
                                        <TableCell >#</TableCell>
                                ...
                                <tbody>
                                    {Collectors.map((collector, index) => (
                                        <tr key={collector.id} onClick={() => { handleClose(); setSelected(collector.name); }}>
                                            <TableCell>{collector.id}</TableCell>
                                            <TableCell>{collector.name}</TableCell>
                                            <TableCell style={{ color: collector.status === "Free" ? "blue" : "red" }}>{collector.status}</TableCell>
        ...
        <>
            ...
            <Modal hideBackdrop open={open} onClose={handleClose}>
                <Box sx={{ ...style, width: 400, display: "flex", flexDirection: "column" }}>
                    ...
                    <Box> {renderTable()} </Box>
                    <div style={{ position: 'absolute', right: '-0', top: '-0' }} className="hover" onClick={handleClose}>
